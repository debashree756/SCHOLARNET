...
<label>Type the name of the student you want to verify details :  </label>
  
    <input type="text" name="name" required autofocus size="30">
        <br>
           
        <br><br>
        <input type="submit" name="submit" value="Show entire details">
