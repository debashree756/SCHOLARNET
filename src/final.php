...
<html lang="en">
  ...
  <body>
    ...
    if($approval == "yes")
    {
			...
			$sql="UPDATE student_details set approvalstatus = 'yes' where name= '$name'";
			
			$result = $conn->query($sql);
$sql="UPDATE system_details set approvalstatus = 'yes' where name= '$name'";
        ...
        echo "<center>Scholarship approved to ".$name."<br> </center>";
      ...
      {
        echo "<center>Scholarship not approved to ".$name."<br> </center>";
      }
