  ...
  <body>
    ...
    <section class="page-section cta">
     ...
     $adharnumber = $_POST['aadhar'];
			...
			$sql="SELECT * FROM student_details where adharnumber= '$adharnumber';";
			...
			{
				echo "<table border='1'><tr><h6><th>NAME </th><th>TYPE OF SCHOLARSHIP APPLIED FOR</th><th>FINAL APPROVAL STATUS</th></tr>";
				//while($row = $result->fetch_assoc())
				while($row = $result->fetch_assoc())
				{
					echo "<tr><td>".$row["name"]."</td><td>".$row["type"]."</td><td>".$row["approvalstatus"]."</td></tr>";
